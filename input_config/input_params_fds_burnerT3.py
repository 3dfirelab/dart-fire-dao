params_run ={# flag that control the driver  
            ...
            'flag_2DfireScene':         False,
            'flag_AtmScene':            False,
            'flag_3DfireScene':         False,
...
params_model = {'Atm_model_name'         : 'FDS', # = MesoNH| FDS
                'onlyAtm'                : False,
                'input_dir'              : '/data/paugam/FDS/BurnerT3/'         ,
                'output_dir'             : '/data/paugam/FDS/BurnerT3/Postproc/',
                'input_fds_config_file'  : 'input_fixed_burnerT3.fds' ,
...
params_3DFS = {#output
               ...
               'time_analysis': [80,90], # ['all'],#['all'], #[46060,46200,46340,46580],
